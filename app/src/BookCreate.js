...
export default class BookList extends Component {
        ...
        if (newBook.ISBN && newBook.title) {
            return http.post('/book', newBook)
                ...
                .catch(err => {
                    ...
                    if (err.errors) {
                        this.setState({
                            duplicateISBN: err.errors[0].message
                        });
                    }
                })
        } else {
    ...
    render() {
        ...
        return (
            <div className="container jumbotron marginTop">
                <div className="row">
                    <label className="col-md-4">Unique ISBN number</label>
                    <input className="form-control col-md-8 inputMargin" id="isbnNumber" type="number" required="true" name="ISBN" onChange={this.handleISBNChange.bind(this)} placeholder="Enter ISBN"/>
                    {duplicateISBN && 
                ...
                <div className="row">
                    ...
                    <input className="form-control col-md-8 inputMargin" id="title" required="true" name="Title" onChange={this.handleTitleChange.bind(this)} placeholder="Title of the Book"/>
                </div>
                <br/>
                <div className="row">
